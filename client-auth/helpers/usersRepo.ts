...
async function authenticate({
  ...
  console.log("(Server)[API | /users/:authenticate]: LOG -", username, password, db.User);
...
async function getById(id) {
  console.log("(Server)[API | /users/:getById]: LOG -", id,  db.User);
...
async function create(parameters) {
  console.log("(Server)[API | /users/:create]: LOG -", parameters, db.User);
...
async function update(id, parameters) {
  console.log("(Server)[API | /users/:update]: LOG -", id, parameters, db.User);
